...
public class CompanyDetailsDto {
	...
	public CompanyDetailsDto(Long companyCode, String stock, String companyName, String companyCEO, Double turnover, String boardOfDirectors, String companyProfile) {
		super();
